SMODS.PokerHand { -- Straight Spectrum (Referenced from SixSuits)
  ...
  evaluate = function(parts)
    if not next(parts.dragqueen_spectrum) or not next(parts._straight) then return {} end
  ...
  modify_display_text = function(self, _cards, scoring_hand)
    ...
    for j = 1, #scoring_hand do
      ...
      royal = rank and royal and (rank.key == 'Ace' or rank.key == '10' or rank.face == true)
    end
